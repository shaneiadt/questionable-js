...
export const Question = ({
  ...
  useEffect(() => {
    ...
    return () => {
      [...document.querySelectorAll("li")].forEach((el) =>
        el.removeEventListener("click", listItemListener),
      );
    };
  ...
  return (
    <div className="question">
      ...
      {index < totalNumberOfQuestions && (
        <button disabled={!userAnswer} onClick={next}>
          Next
        </button>
      )}
    </div>
